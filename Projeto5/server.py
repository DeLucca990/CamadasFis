...
class Server:
    ...
    def checkMsgIntegrity(self, pacote, numPacote):
        ...
        # Se tudo estiver certo, deu bom
            ...
            if (crc_h8 != h8.to_bytes(1, byteorder = "big")) or (crc_h9 != h9.to_bytes(1, byteorder = "big")):
                print(f"\033[36mO CRC está errado! Por favor reenvie o pacote {numPacote}\033[0m")
                return h4, h3
            else:
